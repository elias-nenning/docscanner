    ...
    <AuthGate>
      <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-4xl">
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-zinc-900 tracking-tight">Choose a club</h1>
            <p className="text-zinc-600 mt-1">Pick a studio in your area to view schedule and book.</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {YOGA_STUDIOS.map((s) => (
              <button
                ...
                className="text-left bg-white border border-zinc-200 rounded-2xl p-5 hover:bg-zinc-50 transition"
              >
